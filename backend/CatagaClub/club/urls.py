...
urlpatterns = [
    ...
    # Habitaciones (Views de Django Admin / Template)
    ...
    # Reservas (Views de Django Admin / Template)
    ...
    # API Reservas 
    path('api/reservas/',                      views.api_reservas,                   name='api_reservas_list'),
    path('api/reservas/<int:pk>/',             views.api_reservas,                   name='api_reservas_detail'),

    # API Restaurante / Platos
